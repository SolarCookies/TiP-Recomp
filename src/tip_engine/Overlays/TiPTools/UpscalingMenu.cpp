...
void UpscalingMenuPage::SyncFromCVars() {
    ...
    fsrSharpnessReduction =
        static_cast<float>(rex::cvar::Query<double>("present_fsr_sharpness_reduction"));
    casAdditionalSharpness =
        static_cast<float>(rex::cvar::Query<double>("present_cas_additional_sharpness"));
